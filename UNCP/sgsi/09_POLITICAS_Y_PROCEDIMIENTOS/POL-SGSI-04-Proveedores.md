...
**Versión:** 2.0
**Norma:** ISO/IEC 27001:2022 (Controles A.5.19 — Seguridad en relaciones con proveedores, A.5.20 — Acuerdos con proveedores, A.5.21 — Gestión de riesgos en la cadena de suministro, A.5.22 — Monitoreo y revisión de servicios de proveedores, A.5.23 — Gestión de cambios en servicios de proveedores)
...
## 3. Clasificación de Proveedores según Riesgo
...
## 5. Evaluación de Seguridad del Proveedor
...
## 7. Monitoreo y Control de Accesos
...
## 8. Gestión de Cambios en Servicios de Proveedores
