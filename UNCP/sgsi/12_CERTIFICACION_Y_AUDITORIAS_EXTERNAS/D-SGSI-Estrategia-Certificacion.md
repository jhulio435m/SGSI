...
## 2. Selección de Entidad Certificadora
...
### 2.2 Entidades Certificadoras Recomendadas
...
### 2.3 Proceso de Contratación Recomendado
1. Enviar **solicitud de cotización (RFP)** a las 4 entidades en Q3-2026.
2. Evaluar las propuestas según los criterios de la sección 2.1.
...
## 3. Proceso de Certificación (Fases)
...
### 3.2 Auditoría de Etapa 1 (Revisión Documental)
...
### 3.3 Auditoría de Etapa 2 (Verificación en Campo)
...
### 3.5 Auditorías de Vigilancia (Años 2, 3 y 4)
...
## 4. Preparación Final (Pre-auditoría)

### 4.1 Auditoría de Brecha (Gap Analysis)
...
## 6. Riesgos Identificados para la Certificación
